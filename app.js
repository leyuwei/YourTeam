const translations = {
  en: {
    ...
    'project_edit.error_title_required': 'Title is required',
    ...
    'project_members.modal_title': 'Project Members - {title}',
    'project_members.reorder_hint': 'Drag the handle to reorder current members.',
    'project_members.current_empty': 'No active members.',
    'project_members.history_empty': 'No history records.',
    'project_members.remove_title': 'Remove Member',
    'project_members.remove_date': 'Exit Date',
    'project_members.remove_confirm': 'Remove',
    'project_members.remove_cancel': 'Cancel',
    'project_members.remove_instruction': 'Please set the exit date for {name}.',
    'project_members.error_exit_required': 'Please choose an exit date.',
    'project_members.error_load': 'Failed to load member information. Please try again.',
    'project_members.error_add': 'Failed to add member. Please try again.',
    'project_members.error_remove': 'Failed to remove member. Please try again.',
    'project_members.error_reorder': 'Failed to update member order. Please try again.',
  ...
  zh: {
    ...
    'project_edit.error_title_required': '请填写项目标题',
    ...
    'project_members.modal_title': '项目成员 - {title}',
    'project_members.reorder_hint': '拖动左侧手柄可调整当前成员顺序。',
    'project_members.current_empty': '暂无在职成员。',
    'project_members.history_empty': '暂无历史记录。',
    'project_members.remove_title': '移除成员',
    'project_members.remove_date': '离开日期',
    'project_members.remove_confirm': '移除',
    'project_members.remove_cancel': '取消',
    'project_members.remove_instruction': '请设置 {name} 的离开日期。',
    'project_members.error_exit_required': '请选择离开日期。',
    'project_members.error_load': '加载成员信息失败，请稍后再试。',
    'project_members.error_add': '添加成员失败，请稍后再试。',
    'project_members.error_remove': '移除成员失败，请稍后再试。',
    'project_members.error_reorder': '更新成员顺序失败，请稍后再试。',
