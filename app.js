const translations = {
  en: {
    ...
    'account.data.title': 'Data Migration',
    'account.data.subtitle': 'Export or import site data for migration and backups.',
    'account.data.open_modal': 'Import/Export',
    'account.data.modal_title': 'Data Migration',
    'account.data.export_title': 'One-click Export',
    'account.data.export_hint': 'Bundle the database and all uploaded files into a ZIP download.',
    'account.data.export_button': 'Export Data',
    'account.data.import_title': 'One-click Import',
    'account.data.import_hint': 'Upload a previously exported ZIP to restore the database and uploads.',
    'account.data.import_warning_primary': 'Importing will overwrite the current database and uploaded files. Export a backup first.',
    'account.data.import_warning_secondary': 'Please keep this page open during import to avoid incomplete data.',
    'account.data.import_file_label': 'Select ZIP File',
    'account.data.import_checkbox': 'I understand this will overwrite current data',
    'account.data.import_button': 'Import and Overwrite',
    'account.data.import_confirm': 'Are you sure you want to import and overwrite existing data?',
    'account.data.import_success': 'Data import completed successfully.',
    'account.data.import_error': 'Data import failed. Please verify the ZIP and try again.',
    'account.data.import_invalid_zip': 'Unable to read the ZIP file.',
    'account.data.import_missing_sql': 'The ZIP file is missing database.sql.',
    'account.data.import_upload_error': 'Please choose a valid ZIP file to upload.',
    'account.data.import_confirm_required': 'Please confirm that you understand the data overwrite warning.',
    ...
    'publish.subtitle': 'Manage achievements and upload supporting materials.',
    'publish.download_all': 'Download Files',
    'publish.export': 'Export to Excel',
    'publish.download.empty_title': 'No files available',
    'publish.download.empty_body': 'No achievement files are available to download yet.',
    'publish.download.empty_confirm': 'OK',
    'publish.download.error': 'Download failed. Please try again later.',
    'publish.attributes.edit': 'Edit Attributes',
    'publish.add': 'Add Achievement',
    'publish.table.index': '#',
    'publish.table.member': 'Member',
    'publish.table.updated': 'Updated',
    'publish.table.actions': 'Actions',
    'publish.empty': 'No achievements yet.',
    'publish.filtered_empty': 'No matching achievements.',
    'publish.no_file': 'No file',
    'publish.view_file': 'View file',
    'publish.filter.all': 'All',
    'publish.filter.has_file': 'Has file',
    'publish.filter.no_file': 'No file',
    'publish.filter.placeholder': 'Filter',
    'publish.filter.date_from': 'From',
    'publish.filter.date_to': 'To',
    'publish.filter.range_separator': 'to',
    'publish.filter.clear': 'Clear Filters',
    'publish.section.mine': 'My achievements',
    'publish.section.others': "Other members' achievements",
    'publish.view_only': 'View only',
    'publish.visibility.title': 'Member visibility',
    'publish.visibility.hint': 'Control whether members can view achievements from others.',
    'publish.visibility.switch': 'Allow members to view all achievements',
    'publish.edit': 'Edit',
    'publish.delete': 'Delete',
    'publish.confirm_delete': 'Delete this achievement? This action cannot be undone.',
    'publish.modal.add': 'Add Achievement',
    'publish.modal.edit': 'Edit Achievement',
    'publish.form.member': 'Member',
    'publish.form.member_placeholder': 'Select a member',
    'publish.form.file_hint': 'Upload supporting files or screenshots.',
    'publish.form.clear_file': 'Clear File',
    'publish.form.current_file': 'Current file',
    'publish.form.selected_file': 'Selected file',
    'publish.form.will_clear': 'Current file will be removed',
    'publish.cancel': 'Cancel',
    'publish.save': 'Save',
    'publish.attributes.modal_title': 'Edit Attributes',
    'publish.attributes.description': 'Define the fields required for each achievement.',
    'publish.attributes.add': 'Add Attribute',
    'publish.attributes.validation': 'Please provide a Chinese or English name for each attribute.',
    'publish.attributes.save_error': 'Save failed. Please try again later.',
    'publish.attributes.empty': 'No achievement attributes yet.',
    'publish.attributes.field.name_zh': 'Chinese name',
    'publish.attributes.field.name_en': 'English name',
    'publish.attributes.field.type': 'Attribute type',
    'publish.attributes.field.default_value': 'Default value',
    'publish.attributes.field.options': 'Options',
    'publish.attributes.field.options_hint': 'Separate multiple options with commas.',
    'publish.attributes.field.options_placeholder': 'Option A, Option B',
    'publish.attributes.type.text': 'Text',
    'publish.attributes.type.textarea': 'Paragraph',
    'publish.attributes.type.date': 'Date',
    'publish.attributes.type.select': 'Dropdown',
    'publish.attributes.type.file': 'File',
    'publish.attributes.delete': 'Delete',
    ...
    'index.pending_notifications.must_hint': 'MUST notifications must be checked before you can continue.',
  ...
  'members.filter.exited': 'Exited',
    ...
    'todolist.this_week': 'This Week',
    'todolist.schedule.open': 'Schedule',
    'todolist.schedule.title': 'Schedule Todo',
    'todolist.schedule.date': 'Date',
    'todolist.schedule.category': 'Category',
    'todolist.schedule.content': 'Todo Content',
    'todolist.schedule.content_placeholder': 'Enter a todo item',
    'todolist.schedule.submit': 'Create',
    'todolist.schedule.cancel': 'Close',
    'todolist.schedule.validation.date': 'Please choose a date.',
    'todolist.schedule.validation.content': 'Please enter todo content.',
    'todolist.schedule.validation.future': 'Please choose a future date.',
    ...
    'todolist.note.title': 'Multi-platform note',
    'todolist.note.placeholder': 'Capture ideas or cross-platform info',
    'todolist.note.expand': 'Expand',
    'todolist.note.collapse': 'Collapse',
    'todolist.note.clear': 'Clear',
    'todolist.note.clear_confirm': 'Clear this note? This cannot be undone.',
    'todolist.note.autosave': 'Saved automatically',
    'todolist.note.count': 'Characters: {count}',
  ...
  'tasks.table_description': 'Description',
  'tasks.table_start': 'Start',
    ...
    'workload.error.db': 'Failed to load workload data. Please try again later.',
    'workload.label.start': 'Start Date',
    'workload.label.end': 'End Date',
    'workload.label.category_filter': 'Task Categories',
    'workload.label.category_hint': 'Use multi-select to limit statistics by category.',
    'workload.category.select': 'Select Categories',
    'workload.category.all': 'All categories included',
    'workload.category.some': '%d categories selected',
    'workload.category.modal_title': 'Choose Task Categories',
    'workload.category.select_all': 'Select all categories',
    'workload.category.cancel': 'Cancel',
    'workload.category.apply': 'Apply',
    'workload.generate': 'Generate',
    'workload.export': 'Export to EXCEL',
    'workload.export_txt': 'Export to TXT',
    'workload.quick.this_month': 'This Month',
    'workload.quick.last_month': 'Last Month',
    'workload.quick.pick_month': 'Apply Month',
    'workload.sort.title': 'Sort Priority',
    'workload.sort.total_desc': 'Total Days ↓',
    'workload.sort.total_asc': 'Total Days ↑',
    'workload.sort.category_desc': 'Category Count ↓',
    'workload.sort.category_asc': 'Category Count ↑',
    'workload.sort.name_asc': 'Name A→Z',
    'workload.sort.name_desc': 'Name Z→A',
    'workload.sort.none': 'No secondary sort',
    'workload.table.rank': 'Rank',
    'workload.table.campus_id': 'Campus ID',
    'workload.table.name': 'Name',
    'workload.table.category_count': 'Category Count',
    'workload.table.category_breakdown': 'Category Breakdown',
    'workload.table.task_detail': 'Task Detail',
    'workload.table.task_days': 'Task Days',
    'workload.table.none': 'None',
    'workload.card.total': 'Total Workload (days)',
    'workload.card.members': 'Members Count',
    'workload.card.categories': 'Distinct Categories',
    ...
    'leave.current.title': 'Currently On Leave',
    'leave.current.none': 'No one is currently on leave.',
    'leave.summary.year': 'Year {year}',
    'leave.summary.applied_days': 'Applied Days',
    'leave.summary.approved_days': 'Approved Days',
    'leave.summary.unit_days': 'days',
    'leave.section.pending': 'Pending Requests',
    'leave.section.approved': 'Approved / Returned',
    'leave.section.rejected': 'Rejected Requests',
    'leave.ranking.open': 'Leave Ranking',
    'leave.ranking.title': 'Leave Days Ranking',
    'leave.ranking.hint': 'Ranking by approved leave days in {year}.',
    'leave.ranking.rank': 'Rank',
    'leave.ranking.member': 'Member',
    'leave.ranking.days': 'Approved Days',
    'leave.ranking.none': 'No ranking data.',
    'leave.table.member': 'Member',
    'leave.table.type': 'Leave Type',
    'leave.table.start': 'Start Date',
    'leave.table.end': 'End Date',
    'leave.table.actual_end': 'Actual End Date',
    'leave.table.reason': 'Reason',
    'leave.table.reject_reason': 'Rejection Reason',
    'leave.table.status': 'Status',
    'leave.table.actions': 'Actions',
    'leave.type.personal': 'Personal Leave',
    'leave.type.sick': 'Sick Leave',
    'leave.type.winter_summer': 'Winter/Summer Vacation',
    'leave.type.internship': 'Internship Leave',
    'leave.type.group_activity': 'Group Activity',
    'leave.type.statutory_holiday': 'Statutory Holiday',
    'leave.type.other': 'Other',
    'leave.status.pending': 'Pending',
    'leave.status.approved': 'Approved',
    'leave.status.rejected': 'Rejected',
    'leave.status.returned': 'Returned Early',
    'leave.action.approve': 'Approve',
    'leave.action.reject': 'Reject',
    'leave.action.return': 'Return Early',
    'leave.action.view_reason': 'View Reason',
    'leave.modal.apply_title': 'Apply Leave',
    'leave.modal.reject_title': 'Reject Leave',
    'leave.modal.return_title': 'Return Early',
    'leave.modal.rejected_reason_title': 'Rejection Reason',
    'leave.form.type': 'Leave Type',
    'leave.form.start': 'Start Date',
    'leave.form.end': 'End Date',
    'leave.form.reason': 'Reason',
    'leave.form.reject_reason': 'Rejection Reason',
    'leave.form.actual_end': 'Actual Return Date',
    'leave.form.save': 'Submit',
    'leave.form.confirm': 'Confirm',
    'leave.form.cancel': 'Cancel',
    'leave.none': 'No leave records.',
    'leave.toggle.show_pending': 'Show pending requests',
    'leave.toggle.hide_pending': 'Hide pending requests',
    'leave.toggle.show_approved': 'Show approved and returned requests',
    'leave.toggle.hide_approved': 'Hide approved and returned requests',
    'leave.toggle.show_rejected': 'Show rejected requests',
    'leave.toggle.hide_rejected': 'Hide rejected requests',
    'leave.toggle.show_current': 'Show members currently on leave',
    'leave.toggle.hide_current': 'Hide members currently on leave',
    ...
    'leave.message.db_not_ready': 'Leave data table is not ready. Please run update_db.sql first.',
    'leave.message.load_failed': 'Unable to load leave data. Please run update_db.sql and refresh.',
    ...
    'notification_edit.label_must': 'MUST (required before closing reminders)',
    'notification_edit.label_members': 'Target Members',
    'notification_edit.select_all': 'Select All',
    'notification_edit.quick_select_project': 'By Project',
    'notification_edit.quick_select_direction': 'By Direction',
    'notification_edit.quick_select_placeholder': 'Select',
    'notification_edit.quick_select_add': 'Select',
    'notification_edit.quick_select_remove': 'Remove',
    'notification_edit.quick_select_hint': 'Quickly select members by project or research direction.',
  ...
  ,
    ...
    'assets.table.sort_hint': 'Click to sort',
    'assets.table.sort_asc': 'Sorted ascending',
    'assets.table.sort_desc': 'Sorted descending',
    ...
    'assets.form.owner_member_hint': 'Members can assign assets only to themselves or leave them unassigned.',
    ...
    'assets.messages.owner_restricted': 'You can only assign assets to yourself or leave them unassigned.',
  ...
  'reimburse.keywords.word': 'Keyword',
    ...
    'collect.allow_download': 'Allow download',
    'collect.allow_download_hint': 'Let users download submissions',
    ...
    'collect.quick_select_project': 'By Project',
    'collect.quick_select_direction': 'By Direction',
    'collect.quick_select_placeholder': 'Select',
    'collect.quick_select_add': 'Select',
    'collect.quick_select_remove': 'Remove',
    'collect.quick_select_hint': 'Quickly select members by project or research direction.',
  ...
  zh: {
    ...
    'account.data.title': '数据迁移',
    'account.data.subtitle': '快速导出与导入站点数据，便于迁移或备份。',
    'account.data.open_modal': '导入/导出',
    'account.data.modal_title': '数据迁移',
    'account.data.export_title': '一键导出',
    'account.data.export_hint': '将数据库与所有上传文件打包为 ZIP 下载。',
    'account.data.export_button': '导出数据',
    'account.data.import_title': '一键导入',
    'account.data.import_hint': '请上传导出的 ZIP 包以恢复数据库及上传内容。',
    'account.data.import_warning_primary': '导入会覆盖当前数据库与上传文件，建议先导出备份。',
    'account.data.import_warning_secondary': '导入过程中请勿关闭页面，以免造成数据不完整。',
    'account.data.import_file_label': '选择 ZIP 文件',
    'account.data.import_checkbox': '我已了解该操作将覆盖当前数据',
    'account.data.import_button': '导入并覆盖',
    'account.data.import_confirm': '确定要导入并覆盖现有数据吗？',
    'account.data.import_success': '数据导入完成。',
    'account.data.import_error': '数据导入失败，请检查 ZIP 包后重试。',
    'account.data.import_invalid_zip': '无法读取 ZIP 文件。',
    'account.data.import_missing_sql': 'ZIP 包内缺少 database.sql 文件。',
    'account.data.import_upload_error': '请上传有效的 ZIP 文件。',
    'account.data.import_confirm_required': '请确认已了解覆盖提示。',
    ...
    'publish.title': '成果',
    'publish.subtitle': '管理成果并上传佐证材料。',
    'publish.download_all': '下载成果文件',
    'publish.export': '导出成果到Excel',
    'publish.download.empty_title': '暂无文件',
    'publish.download.empty_body': '当前还没有可下载的成果文件。',
    'publish.download.empty_confirm': '知道了',
    'publish.download.error': '下载失败，请稍后重试。',
    'publish.attributes.edit': '编辑成果属性',
    'publish.add': '新增成果',
    'publish.table.index': '序号',
    'publish.table.member': '成员',
    'publish.table.updated': '更新时间',
    'publish.table.actions': '操作',
    'publish.empty': '暂无成果记录。',
    'publish.filtered_empty': '暂无匹配的成果记录。',
    'publish.no_file': '暂无文件',
    'publish.view_file': '查看文件',
    'publish.filter.all': '全部',
    'publish.filter.has_file': '有文件',
    'publish.filter.no_file': '无文件',
    'publish.filter.placeholder': '筛选',
    'publish.filter.date_from': '开始日期',
    'publish.filter.date_to': '结束日期',
    'publish.filter.range_separator': '至',
    'publish.filter.clear': '清空筛选',
    'publish.section.mine': '我的成果',
    'publish.section.others': '其他成员成果',
    'publish.view_only': '仅查看',
    'publish.visibility.title': '成员可见性',
    'publish.visibility.hint': '控制一般成员是否能查看其他成员的成果。',
    'publish.visibility.switch': '允许成员查看全部成果',
    'publish.edit': '编辑',
    'publish.delete': '删除',
    'publish.confirm_delete': '确认删除该成果？此操作无法撤销。',
    'publish.modal.add': '新增成果',
    'publish.modal.edit': '编辑成果',
    'publish.form.member': '成员',
    'publish.form.member_placeholder': '请选择成员',
    'publish.form.file_hint': '上传佐证文件或截图。',
    'publish.form.clear_file': '清除文件',
    'publish.form.current_file': '当前文件',
    'publish.form.selected_file': '已选择文件',
    'publish.form.will_clear': '将删除当前文件',
    'publish.cancel': '取消',
    'publish.save': '保存',
    'publish.attributes.modal_title': '编辑成果属性',
    'publish.attributes.description': '定义每条成果需要上报的字段。',
    'publish.attributes.add': '新增属性',
    'publish.attributes.validation': '请为每个属性提供中文或英文名称。',
    'publish.attributes.save_error': '保存失败，请稍后重试。',
    'publish.attributes.empty': '暂无成果属性。',
    'publish.attributes.field.name_zh': '中文名称',
    'publish.attributes.field.name_en': '英文名称',
    'publish.attributes.field.type': '属性类型',
    'publish.attributes.field.default_value': '默认值',
    'publish.attributes.field.options': '可选项',
    'publish.attributes.field.options_hint': '用逗号分隔多个可选项。',
    'publish.attributes.field.options_placeholder': '选项A, 选项B',
    'publish.attributes.type.text': '文本',
    'publish.attributes.type.textarea': '多行文本',
    'publish.attributes.type.date': '日期',
    'publish.attributes.type.select': '下拉选项',
    'publish.attributes.type.file': '文件',
    'publish.attributes.delete': '删除',
    ...
    'index.pending_notifications.must_hint': '存在“必做（MUST）”通知时，必须全部标记已处理后才能继续操作。',
  ...
  'members.filter.exited': '已离退',
    ...
    'todolist.this_week': '回本周',
    'todolist.schedule.open': '预定事项',
    'todolist.schedule.title': '预定事项',
    'todolist.schedule.date': '日期',
    'todolist.schedule.category': '类别',
    'todolist.schedule.content': '事项内容',
    'todolist.schedule.content_placeholder': '请输入待办事项',
    'todolist.schedule.submit': '创建',
    'todolist.schedule.cancel': '关闭',
    'todolist.schedule.validation.date': '请选择日期。',
    'todolist.schedule.validation.content': '请输入待办事项内容。',
    'todolist.schedule.validation.future': '请选择未来日期。',
    ...
    'todolist.note.title': '跨平台记事本',
    'todolist.note.placeholder': '随手记录灵感或跨平台信息',
    'todolist.note.expand': '展开',
    'todolist.note.collapse': '收起',
    'todolist.note.clear': '清空',
    'todolist.note.clear_confirm': '确定要清空记事本吗？此操作无法撤销。',
    'todolist.note.autosave': '实时保存',
    'todolist.note.count': '字数 {count}',
    ...
    'workload.error.db': '加载工作量数据失败，请稍后再试。',
    'workload.label.start': '报表起始时间',
    'workload.label.end': '报表截止时间',
    'workload.label.category_filter': '任务类别筛选',
    'workload.label.category_hint': '可多选任务类别来限定统计范围。',
    'workload.category.select': '选择任务类别',
    'workload.category.all': '已包含全部任务类别',
    'workload.category.some': '已选择 %d 个任务类别',
    'workload.category.modal_title': '批量选择任务类别',
    'workload.category.select_all': '全选全部任务类别',
    'workload.category.cancel': '取消',
    'workload.category.apply': '应用',
    'workload.generate': '生成报表',
    'workload.export': '导出为EXCEL',
    'workload.export_txt': '导出为TXT文字报表',
    'workload.quick.this_month': '本月',
    'workload.quick.last_month': '上月',
    'workload.quick.pick_month': '按月份套用',
    'workload.sort.title': '排序优先级',
    'workload.sort.total_desc': '总天数↓',
    'workload.sort.total_asc': '总天数↑',
    'workload.sort.category_desc': '类别数↓',
    'workload.sort.category_asc': '类别数↑',
    'workload.sort.name_asc': '姓名A→Z',
    'workload.sort.name_desc': '姓名Z→A',
    'workload.sort.none': '无次级排序',
    'workload.table.rank': '排名',
    'workload.table.campus_id': '一卡通号',
    'workload.table.name': '姓名',
    'workload.table.category_count': '参与任务类别数',
    'workload.table.category_breakdown': '类别占比',
    'workload.table.task_detail': '具体任务',
    'workload.table.task_days': '任务投入天数',
    'workload.table.none': '暂无',
    'workload.card.total': '累计工作量（天）',
    'workload.card.members': '参与成员数',
    'workload.card.categories': '覆盖任务类别',
    ...
    'notifications.must_badge': '必做（MUST）',
    ...
    'leave.title': '请假管理',
    'leave.apply': '申请请假',
    'leave.current.title': '当前休假中人员',
    'leave.current.none': '当前无人休假。',
    'leave.summary.year': '{year} 年度',
    'leave.summary.applied_days': '已申请天数',
    'leave.summary.approved_days': '已获批天数',
    'leave.summary.unit_days': '天',
    'leave.section.pending': '待审批请假',
    'leave.section.approved': '已批准/已销假',
    'leave.section.rejected': '已拒绝请假',
    'leave.ranking.open': '请假排行榜',
    'leave.ranking.title': '请假天数排行榜',
    'leave.ranking.hint': '{year} 年度已获批请假天数排行。',
    'leave.ranking.rank': '排名',
    'leave.ranking.member': '成员',
    'leave.ranking.days': '已获批天数',
    'leave.ranking.none': '暂无排行数据。',
    'leave.table.member': '成员',
    'leave.table.type': '请假类型',
    'leave.table.start': '开始日期',
    'leave.table.end': '结束日期',
    'leave.table.actual_end': '实际结束日期',
    'leave.table.reason': '请假事由',
    'leave.table.reject_reason': '拒绝理由',
    'leave.table.status': '状态',
    'leave.table.actions': '操作',
    'leave.type.personal': '事假',
    'leave.type.sick': '病假',
    'leave.type.winter_summer': '寒暑假',
    'leave.type.internship': '实习假',
    'leave.type.group_activity': '集体活动',
    'leave.type.statutory_holiday': '法定节假日',
    'leave.type.other': '其它',
    'leave.status.pending': '待审批',
    'leave.status.approved': '已批准',
    'leave.status.rejected': '已拒绝',
    'leave.status.returned': '已提前销假',
    'leave.action.approve': '批准',
    'leave.action.reject': '拒绝',
    'leave.action.return': '提前销假',
    'leave.action.view_reason': '查看理由',
    'leave.modal.apply_title': '申请请假',
    'leave.modal.reject_title': '拒绝请假',
    'leave.modal.return_title': '提前销假',
    'leave.modal.rejected_reason_title': '拒绝理由',
    'leave.form.type': '请假类型',
    'leave.form.start': '开始日期',
    'leave.form.end': '结束日期',
    'leave.form.reason': '请假事由',
    'leave.form.reject_reason': '拒绝理由',
    'leave.form.actual_end': '实际返岗日期',
    'leave.form.save': '提交',
    'leave.form.confirm': '确认',
    'leave.form.cancel': '取消',
    'leave.none': '暂无请假记录。',
    'leave.toggle.show_pending': '展开待审批请假',
    'leave.toggle.hide_pending': '收起待审批请假',
    'leave.toggle.show_approved': '展开已批准/已销假',
    'leave.toggle.hide_approved': '收起已批准/已销假',
    'leave.toggle.show_rejected': '展开已拒绝请假',
    'leave.toggle.hide_rejected': '收起已拒绝请假',
    'leave.toggle.show_current': '展开当前休假中人员',
    'leave.toggle.hide_current': '收起当前休假中人员',
    'leave.message.create_success': '请假申请已提交。',
    'leave.message.approve_success': '请假申请已批准。',
    'leave.message.reject_success': '请假申请已拒绝。',
    'leave.message.return_success': '提前销假成功。',
    'leave.message.invalid_date': '开始日期不能晚于结束日期。',
    'leave.message.invalid_type': '请选择有效的请假类型。',
    'leave.message.reason_required': '请填写请假事由。',
    'leave.message.reject_reason_required': '请填写拒绝理由。',
    'leave.message.no_permission': '你没有权限执行该操作。',
    'leave.message.not_found_or_status': '请假记录不存在或状态已变更。',
    'leave.message.return_date_range': '实际返岗日期必须在开始日期与今天之间。',
    'leave.message.not_in_leave_period': '仅可在已批准且休假进行中时提前销假。',
    'leave.message.request_id_required': '无效的请假记录编号。',
    'leave.message.invalid_date_format': '请提供有效日期。',
    'leave.message.system_error': '系统错误，请先执行 update_db.sql 后重试。',
    'leave.message.db_not_ready': '请假数据表未就绪，请先执行 update_db.sql。',
    'leave.message.load_failed': '请假数据加载失败，请先执行 update_db.sql 后刷新页面。',
  ...
  'notification_edit.label_must': '必做（MUST，未处理前将强制提醒）',
  'notification_edit.label_members': '目标成员',
  'notification_edit.select_all': '全选',
  'notification_edit.quick_select_project': '按项目',
  'notification_edit.quick_select_direction': '按研究方向',
  'notification_edit.quick_select_placeholder': '请选择',
  'notification_edit.quick_select_add': '选中',
  'notification_edit.quick_select_remove': '取消选择',
  'notification_edit.quick_select_hint': '可按项目或研究方向快速勾选成员。',
  ...
  ,
    ...
    'assets.table.sort_hint': '点击排序',
    'assets.table.sort_asc': '升序排序',
    'assets.table.sort_desc': '降序排序',
    'assets.none': '暂无固定资产',
    ...
    'assets.form.owner_member_hint': '普通成员只能将资产划归自己或设置为无主资产。',
    ...
    'assets.messages.owner_restricted': '只能将资产划归自己或设置为无主资产。',
  ...
  'collect.allow_download': '允许下载',
  'collect.allow_download_hint': '允许成员下载提交结果',
  ...
  'collect.quick_select_project': '按项目',
  'collect.quick_select_direction': '按研究方向',
  'collect.quick_select_placeholder': '请选择',
  'collect.quick_select_add': '选中',
  'collect.quick_select_remove': '取消选择',
  'collect.quick_select_hint': '可按项目或研究方向快速勾选成员。',
  'collect.fields': '字段',
...
function applyTranslations() {
  ...
  document.querySelectorAll('[data-publish-name-zh]').forEach(el => {
    const zhName = el.getAttribute('data-publish-name-zh') || '';
    const enName = el.getAttribute('data-publish-name-en') || '';
    const fallback = typeof el.textContent === 'string' ? el.textContent : '';
    const text = lang === 'en'
      ? (enName || zhName || fallback)
      : (zhName || enName || fallback);
