const translations = {
  en: {
    ...
    'collect.subtitle': 'Launch structured data collection and track completion at a glance.',
    'collect.add_template': 'New Template',
    'collect.status.legend': 'Status Legend',
    'collect.status.desc': 'Open for filling, paused temporarily, or archived when finished/voided.',
    'collect.status.update': 'Update',
    'collect.status.open': 'Open',
    'collect.status.paused': 'Paused',
    'collect.status.ended': 'Ended',
    'collect.status.void': 'Voided',
    'collect.deadline_label': 'Deadline:',
    'collect.fields': 'Fields',
    'collect.fields.empty': 'No fields configured.',
    'collect.targets': 'Target Members',
    'collect.targets.empty': 'No target members added.',
    'collect.completion': 'Completion',
    'collect.completed': 'completed',
    'collect.pending': 'pending',
    'collect.archive.toggle': 'Show ended/voided templates',
    'collect.archive.empty': 'No ended or voided templates.',
    'collect.table.member': 'Member',
    'collect.table.department': 'Department',
    'collect.table.status': 'Status',
    'collect.table.action': 'Action',
    'collect.member_status.submitted': 'Submitted',
    'collect.member_status.pending': 'Pending',
    'collect.member.toggle': 'Toggle',
    'collect.type.text': 'Text',
    'collect.type.number': 'Number',
    'collect.type.select': 'Dropdown',
    'collect.type.file': 'File',
    'collect.required': 'Required',
    'collect.optional': 'Optional',
    'collect.select.options': 'Options: {options}',
    'collect.alert.template_missing': 'Template not found.',
    'collect.alert.not_open': 'This template is not open for new submissions.',
    'collect.alert.not_assigned': 'You are not assigned to this collection.',
    'collect.alert.required': 'Please complete all required fields.',
    'collect.alert.invalid_number': 'Please enter a valid number.',
    'collect.alert.invalid_option': 'Please choose a valid option.',
    'collect.alert.upload_failed': 'File upload failed, please try again.',
    'collect.alert.submitted': 'Submission received. Thank you!',
    'collect.member.submissions': '{count} entries',
    'collect.fill.title': 'Fill and submit',
    'collect.fill.multi': 'Multiple submissions allowed',
    'collect.fill.paused': 'This template is paused or closed for new submissions.',
    'collect.fill.select_placeholder': 'Please choose',
    'collect.fill.submit': 'Submit',
    'collect.fill.history': 'Your submissions',
    'collect.fill.count': 'You have submitted {count} time(s).',
    'collect.fill.empty': 'No submissions yet. Please fill the form.',
    'collect.fill.completed': 'Submitted',
    'collect.modal.title': 'New Collect Template',
    'collect.modal.name': 'Template Name',
    'collect.modal.deadline': 'Deadline',
    'collect.modal.status': 'Initial Status',
    'collect.modal.fields': 'Field Builder',
    'collect.modal.fields_hint': 'Add each field with bilingual labels and choose the type.',
    'collect.modal.add_field': 'Add Field',
    'collect.modal.targets': 'Target Members',
    'collect.modal.targets_hint': 'Select who needs to fill this template.',
    'collect.modal.search_members': 'Filter members',
    'collect.modal.cancel': 'Cancel',
    'collect.modal.save': 'Save Template',
    'collect.field.label_en': 'Label (EN)',
    'collect.field.label_zh': 'Label (ZH)',
    'collect.field.type': 'Type',
    'collect.field.required': 'Required',
    'collect.field.remove': 'Remove',
    'collect.field.options': 'Options (comma separated)',
  ...
  zh: {
    ...
    'collect.subtitle': '发起结构化信息收集，一眼看到完成进度。',
    'collect.add_template': '新建模板',
    'collect.status.legend': '状态说明',
    'collect.status.desc': '开放填写、暂时暂停，或在结束/作废后收纳归档。',
    'collect.status.update': '更新',
    'collect.status.open': '开放填写',
    'collect.status.paused': '暂停填写',
    'collect.status.ended': '结束填写',
    'collect.status.void': '作废',
    'collect.deadline_label': '截止日期：',
    'collect.fields': '填报字段',
    'collect.fields.empty': '尚未配置字段。',
    'collect.targets': '目标成员',
    'collect.targets.empty': '还没有添加目标成员。',
    'collect.completion': '完成度',
    'collect.completed': '已完成',
    'collect.pending': '未完成',
    'collect.archive.toggle': '展开已结束/作废模板',
    'collect.archive.empty': '暂无已结束或作废的模板。',
    'collect.table.member': '成员',
    'collect.table.department': '部门',
    'collect.table.status': '状态',
    'collect.table.action': '操作',
    'collect.member_status.submitted': '已填报',
    'collect.member_status.pending': '待填报',
    'collect.member.toggle': '切换状态',
    'collect.type.text': '文字',
    'collect.type.number': '数字',
    'collect.type.select': '下拉框',
    'collect.type.file': '文件',
    'collect.required': '必填',
    'collect.optional': '选填',
    'collect.select.options': '选项：{options}',
    'collect.alert.template_missing': '未找到对应模板。',
    'collect.alert.not_open': '当前模板未开放填写。',
    'collect.alert.not_assigned': '你不在该收集的目标名单中。',
    'collect.alert.required': '请填写所有必填项。',
    'collect.alert.invalid_number': '请输入正确的数字。',
    'collect.alert.invalid_option': '请选择有效选项。',
    'collect.alert.upload_failed': '文件上传失败，请重试。',
    'collect.alert.submitted': '提交成功，感谢填写！',
    'collect.member.submissions': '已提交 {count} 条',
    'collect.fill.title': '填写并提交',
    'collect.fill.multi': '可重复提交',
    'collect.fill.paused': '该模板已暂停或关闭填写。',
    'collect.fill.select_placeholder': '请选择',
    'collect.fill.submit': '提交',
    'collect.fill.history': '我的提交记录',
    'collect.fill.count': '你已提交 {count} 次。',
    'collect.fill.empty': '暂无提交，请先填写。',
    'collect.fill.completed': '已提交',
    'collect.modal.title': '新建收集模板',
    'collect.modal.name': '模板名称',
    'collect.modal.deadline': '截止日期',
    'collect.modal.status': '初始状态',
    'collect.modal.fields': '字段设计器',
    'collect.modal.fields_hint': '为每个字段填写中英文名称并选择类型。',
    'collect.modal.add_field': '添加字段',
    'collect.modal.targets': '目标成员',
    'collect.modal.targets_hint': '选择需要填写的成员。',
    'collect.modal.search_members': '筛选成员',
    'collect.modal.cancel': '取消',
    'collect.modal.save': '保存模板',
    'collect.field.label_en': '英文标签',
    'collect.field.label_zh': '中文标签',
    'collect.field.type': '字段类型',
    'collect.field.required': '是否必填',
    'collect.field.remove': '删除',
    'collect.field.options': '选项（逗号分隔）',
