const translations = {
  en: {
    ...
    'member_edit.error_generic': 'Failed to save member.',
    'member_edit.load_failed': 'Unable to load member details.',
    ...
    'task_edit.error_generic': 'Failed to save task.',
    'task_edit.load_failed': 'Failed to load task.',
  ...
  'members.attributes.manage': 'Edit Attributes',
  'members.attributes.section_title': 'Custom Attributes',
  'members.attributes.none': 'No custom attributes yet.',
  'members.attributes.label_zh': 'Label (Chinese)',
  'members.attributes.label_en': 'Label (English)',
  'members.attributes.default': 'Default Value',
  'members.attributes.apply_default': 'Apply default value to all members',
  'members.attributes.reset': 'Reset',
  'members.attributes.save': 'Save Attribute',
  'members.attributes.current': 'Configured Attributes',
  'members.attributes.add': 'Add Attribute',
  'members.attributes.close': 'Close',
  'members.attributes.edit': 'Edit',
  'members.attributes.delete': 'Delete',
  'members.attributes.confirm_delete': 'Delete this attribute?',
  ...
  'tasks.table_start': 'Start',
    ...
    'notifications.members.none': 'No members available.',
    ...
    'notification_edit.error_generic': 'Failed to save notification.',
    'notification_edit.load_failed': 'Failed to load notification.',
  ...
  'reimburse.batch.load_failed': 'Failed to load receipt.',
  'reimburse.batch.save_error': 'Failed to save receipt.',
  ...
  zh: {
    ...
    'member_edit.error_generic': '保存失败，请重试。',
    'member_edit.load_failed': '成员信息加载失败。',
    ...
    'task_edit.save': '保存',
    'task_edit.cancel': '取消',
    'task_edit.error_generic': '保存任务失败。',
    'task_edit.load_failed': '加载任务失败。',
  ...
  'members.attributes.manage': '编辑属性',
  'members.attributes.section_title': '成员自定义属性',
  'members.attributes.none': '暂无自定义属性',
  'members.attributes.label_zh': '中文名称',
  'members.attributes.label_en': '英文名称',
  'members.attributes.default': '默认值',
  'members.attributes.apply_default': '将默认值同步到所有成员',
  'members.attributes.reset': '重置',
  'members.attributes.save': '保存属性',
  'members.attributes.current': '已配置属性',
  'members.attributes.add': '新增属性',
  'members.attributes.close': '关闭',
  'members.attributes.edit': '编辑',
  'members.attributes.delete': '删除',
  'members.attributes.confirm_delete': '确认删除该属性？',
  ...
  'members.filter.exited': '已离退',
    ...
    'notifications.members.none': '暂无可选成员。',
    ...
    'notification_edit.error_generic': '保存通知失败。',
    'notification_edit.load_failed': '通知信息加载失败。',
  ...
  'reimburse.batch.load_failed': '加载报销单失败。',
  'reimburse.batch.save_error': '保存报销单失败。',
