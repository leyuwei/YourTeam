const translations = {
  ...
  'reimburse.announcement.edit': 'Edit Announcement',
    ...
    'askme.title': 'AskMe',
    'askme.subtitle': 'Search offices, assets, and the AskMe knowledge base.',
    'askme.search_label': 'What do you want to know?',
    'askme.search_placeholder': 'Search offices, assets, or knowledge snippets…',
    'askme.search_button': 'Search',
    'askme.section.knowledge': 'AskMe Knowledge Base',
    'askme.section.offices': 'Offices',
    'askme.section.assets': 'Assets',
    'askme.no_results': 'No matching results.',
    'askme.empty_state': 'Enter a keyword to start a fuzzy search.',
    'askme.admin.manage_button': 'Manage Knowledge Base',
    'askme.admin.modal_title': 'Edit AskMe Knowledge Base',
    'askme.admin.new_entry': 'Create New Entry',
    'askme.admin.content_zh': 'Chinese Content',
    'askme.admin.content_en': 'English Content',
    'askme.admin.keywords_zh': 'Chinese Keywords (comma separated)',
    'askme.admin.keywords_en': 'English Keywords (comma separated)',
    'askme.admin.keywords_placeholder': 'e.g. travel, reimbursement, office',
    'askme.admin.save': 'Save',
    'askme.admin.existing_entries': 'Existing Entries',
    'askme.admin.empty': 'No knowledge entries yet.'
  },
  zh: {
    'nav.home': '团队管理',
    'nav.members': '成员列表',
  ...
  'askme.title': '不懂问我',
  'askme.subtitle': '模糊搜索办公地点、固定资产与AskMe知识库。',
  'askme.search_label': '你想了解什么？',
  'askme.search_placeholder': '搜索办公地点、资产或知识库…',
  'askme.search_button': '搜索',
  'askme.section.knowledge': 'AskMe 知识库',
  'askme.section.offices': '办公地点',
  'askme.section.assets': '固定资产',
  'askme.no_results': '没有匹配的结果。',
  'askme.empty_state': '输入关键词开始搜索，支持模糊匹配。',
  'askme.admin.manage_button': '管理知识库',
  'askme.admin.modal_title': '编辑AskMe知识库',
  'askme.admin.new_entry': '新增知识条目',
  'askme.admin.content_zh': '中文内容',
  'askme.admin.content_en': '英文内容',
  'askme.admin.keywords_zh': '中文关键词（逗号分隔）',
  'askme.admin.keywords_en': '英文关键词（逗号分隔）',
  'askme.admin.keywords_placeholder': '例如：出差, 报销, 办公室',
  'askme.admin.save': '保存',
  'askme.admin.existing_entries': '已有条目',
  'askme.admin.empty': '暂无知识条目。'
  }
};
