  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item"><a class="nav-link <?php echo (strpos($current_page, 'askme') === 0 ? 'active' : ''); ?>" href="askme.php" data-i18n="nav.askme">AskMe</a></li>
          ...
          <?php
            $notificationPages = strpos($current_page, 'notification') === 0 || strpos($current_page, 'regulation') === 0;
          ?>
          <li class="nav-item"><a class="nav-link <?php echo ($notificationPages ? 'active' : ''); ?>" href="notifications.php" data-i18n="nav.notifications">Notifications</a></li>
          <?php endif; ?>
